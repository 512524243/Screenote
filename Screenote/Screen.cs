...
namespace Screenote
{
    public partial class Screen : Form
    {
        ...
        {
            if ((DateTime.Now.Ticks - tick > 400000) || (e.X == this.Left && e.Y == this.Top) || (e.X == this.Right - 1 && e.Y == this.Top) || (e.X == this.Left && e.Y == this.Bottom - 1) || (e.X == this.Right - 1 && e.Y == this.Bottom - 1))
            {
